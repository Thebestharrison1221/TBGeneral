...
public abstract class Database {
    ...
    public int tokens = 0;
    public Database(TBGeneral instance){
        plugin = instance;
    }
    ...
    public Integer getTokens(String string) {
        ...
        try {
            ...
            plugin.getLogger().log(Level.SEVERE, ErrorMsgs.sqlConnectionExecute(), ex);
        } finally {
            try {
                if (ps != null)
                    ps.close();
                ...
                plugin.getLogger().log(Level.SEVERE, ErrorMsgs.sqlConnectionClose(), ex);
            }
        }
        return 0;
    }
